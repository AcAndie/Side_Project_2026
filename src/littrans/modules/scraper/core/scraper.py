...
from littrans.modules.scraper.utils.file_io        import load_progress, save_progress, write_markdown
from littrans.modules.scraper.utils.string_helpers import (
    domain_tag as _dtag,
    is_junk_page, make_fingerprint, normalize_title, truncate,
)
from littrans.modules.scraper.utils.ads_filter     import AdsFilter
from littrans.modules.scraper.utils.types          import ProgressDict, SiteProfile
from littrans.modules.scraper.utils.issue_reporter import IssueReporter

from littrans.modules.scraper.core.chapter_writer  import format_chapter_filename, strip_nav_edges
from littrans.modules.scraper.core.story_meta      import (
...
from littrans.modules.scraper.core.navigator       import find_next_url
...
async def find_start_chapter(
    ...
    from littrans.modules.scraper.core.navigator import detect_page_type
    ...
    from littrans.modules.scraper.core.fetch import fetch_page
...
async def _finalize_ads(
    ...
    from littrans.modules.scraper.ai.agents import ai_verify_ads
...
async def _ensure_profile(
    ...
    if pm.has(domain):
        ...
        from littrans.modules.scraper.learning.migrator import needs_migration, migrate_profile
    ...
    if not pm.has(domain) or not pm.is_profile_fresh(domain):
        ...
        from littrans.modules.scraper.learning.phase import run_learning_phase
...
async def _setup_story(
    ...
    if not progress.get("naming_done"):
        from littrans.modules.scraper.learning.naming import run_naming_phase
