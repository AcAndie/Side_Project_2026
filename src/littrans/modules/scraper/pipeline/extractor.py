...
from littrans.modules.scraper.config import FALLBACK_CONTENT_SELECTORS
from littrans.modules.scraper.pipeline.base import BlockType, BlockResult, PipelineContext, ScraperBlock
...
class AIExtractBlock(ScraperBlock):
    ...
    async def execute(self, ctx: PipelineContext) -> BlockResult:
        ...
        try:
            ...
            from littrans.modules.scraper.ai.agents import ai_extract_content
...
def _format_element(el: Tag, formatting_rules: dict | None) -> str:
    ...
    from littrans.modules.scraper.core.formatter import MarkdownFormatter, extract_plain_text
    if formatting_rules:
