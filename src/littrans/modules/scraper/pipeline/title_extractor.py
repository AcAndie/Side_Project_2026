...
from littrans.modules.scraper.utils.string_helpers import normalize_title, strip_site_suffix
...
class UrlSlugTitleBlock(ScraperBlock):
    ...
    async def execute(self, ctx: PipelineContext) -> BlockResult:
        start = time.monotonic()
        try:
            from littrans.modules.scraper.core.extractor import _title_from_url
