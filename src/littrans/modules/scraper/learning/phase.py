...
from littrans.modules.scraper.config import LEARNING_CHAPTERS, get_delay, RE_CHAP_URL, JS_CONTENT_RATIO, JS_MIN_DIFF_CHARS
from littrans.modules.scraper.utils.types import SiteProfile
from littrans.modules.scraper.utils.string_helpers import is_junk_page
...
async def run_learning_phase(
    ...
    """
    from littrans.modules.scraper.utils.string_helpers import domain_tag as _dtag
    ...
    from littrans.modules.scraper.learning.phase_ai import run_10_ai_calls_internal
    ...
    from littrans.modules.scraper.learning.naming import get_raw_title_from_html
